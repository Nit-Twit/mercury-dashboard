  ...
  return (
    <main className="flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center h-[80vh] w-full bg-background">
        <HeadingText>
          <h1 className="text-6xl text-primary tracking-wider">Mercury</h1>
        </HeadingText>
        <h1 className="mt-2 text-2xl">The do-all discord bot</h1>
        <div className="w-1/3 mt-20 flex flex-row items-center justify-around">
          <h1 className="text-center">Serving N/A servers</h1>
          <h1 className="text-center">Total Users: N/A</h1>
        </div>
      </section>
      <section className="h-screen flex flex-col justify-center items-center">
        <HeadingText>
          <h1 className="text-5xl tracking-wide">About</h1>
        </HeadingText>
      </section>
    </main>
  );
